...
public class ObjectResolver extends Resolver
{
    ...
    protected void traverseCollection(final Deque<JsonObject<String, Object>> stack, final JsonObject<String, Object> jsonObj)
    {
        ...
        jsonObj.remove("$values");   // Reduce memory required during processing
    }
        ...
        while (!stack.isEmpty())
        {
            ...
            if (t instanceof ParameterizedType)
            {
                ...
                if (Map.class.isAssignableFrom(clazz))
                {
                    ...
                    if (!map.containsKey("$keys") && !map.containsKey("$values") && map instanceof JsonObject)
                    ...
                    Object[] items = (Object[])map.get("$values");
